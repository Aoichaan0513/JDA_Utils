...
fun Guild.addRolesToMember(member: Member, vararg roles: Role) {
    addRolesToMember(member, roles.toSet())
}
...
fun Guild.addRolesToMember(id: Long, vararg roles: Role) {
    addRolesToMember(id, roles.toSet())
}
...
fun Guild.addRolesToMember(id: String, vararg roles: Role) {
    addRolesToMember(id, roles.toSet())
}
...
fun Guild.removeRolesFromMember(member: Member, vararg roles: Role) {
    removeRolesFromMember(member, roles.toSet())
}
...
fun Guild.removeRolesFromMember(id: Long, vararg roles: Role) {
    removeRolesFromMember(id, roles.toSet())
}
...
fun Guild.removeRolesFromMember(id: String, vararg roles: Role) {
    removeRolesFromMember(id, roles.toSet())
}